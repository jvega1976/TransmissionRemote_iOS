...
@IBDesignable @objcMembers class IconCloud: UIView {
...
@IBDesignable @objcMembers public class IconCloud: NSView {
    ...
    @objc dynamic var iconType = IconCloudType.None {
        didSet {
    ...
    @IBInspectable @objc dynamic public var tintColor: NSColor  {
        set(color) {
    ...
    class func keyPathsForValuesAffectingTintColor() -> Set<AnyHashable>? {
