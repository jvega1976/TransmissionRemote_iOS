...
@objc public enum IconCloudType : Int, Codable {
    case Download
    case Upload
    case Wait
    case Verify
...
@IBDesignable @objcMembers public class IconCloud: UIView {
    ...
    @IBInspectable @objc dynamic public var stringType: String {
        set(value) {
            self.iconType = IconCloudType(stringVal: value)
        }
        get {
            return self.iconType.stringValue()
        }
    }
    ...
    override public func prepareForInterfaceBuilder() {
        ...
        setupValues()
        if stringType == "None" {
            self.iconType = .Download
        } else {
            self.iconType = IconCloudType(stringVal: stringType)
        }
        self.setNeedsDisplay(self.frame)
    }
    ...
    @objc dynamic override public var tintColor: UIColor! {
        didSet {
    ...
    class func keyPathsForValuesAffectingStringType() -> Set<AnyHashable>? {
        return Set<AnyHashable>(["iconType"])
    }
}
...
@IBDesignable @objcMembers public class IconCloud: NSView {
    
    @objc dynamic public override var isFlipped: Bool {
        return true
    }
    
    @objc dynamic public var iconType: IconCloudType = .None {
        didSet {
            if oldValue != iconType {
                stopDownloadAnimation()
                stopWaitAnimation()
...
*/
    ...
    @objc dynamic override public var wantsUpdateLayer: Bool {
        return true
    }
    ...
    func createLayers() {
        ...
        layerArrows = CAShapeLayer()
        /// SCALE
        layerArrows?.contentsScale = NSScreen.main!.backingScaleFactor
        layerClouds?.contentsScale = layerArrows!.contentsScale
        layerLittleArrowUp?.contentsScale = layerClouds!.contentsScale
        layerLittleArrowDown?.contentsScale = layerLittleArrowUp!.contentsScale
        layerWaitArrow?.contentsScale = layerLittleArrowDown!.contentsScale
    ...
    @objc dynamic private var _tintColor: NSColor = .labelColor
    @IBInspectable @objc dynamic public var contentColor: NSColor  {
        set(color) {
            if color != self._tintColor {
    ...
    private func setLayersColors() {
        CATransaction.begin()
        CATransaction.setDisableActions(true)
        /// STROKE
        layerArrows?.strokeColor = contentColor.cgColor
        layerClouds?.strokeColor = layerArrows?.strokeColor
        layerLittleArrowDown?.strokeColor = layerClouds?.strokeColor
        layerLittleArrowUp?.strokeColor = layerLittleArrowDown?.strokeColor
        layerCrossButton?.strokeColor = layerLittleArrowUp?.strokeColor
    ...
    @objc dynamic public var image: NSImage {
        let imageRepresentation = bitmapImageRepForCachingDisplay(in: self.bounds)!
        cacheDisplay(in: self.bounds, to: imageRepresentation)
    ...
    var cloudPath: CGPath {
        ...
        if path == nil {
            ...
            cloudPath.move(to: CGPoint(x: 0.24846 * w, y: 0.71086 * h))
            cloudPath.line(to: CGPoint(x: 0.20217 * w, y: 0.71086 * h))
            cloudPath.curve(to: CGPoint(x: 0.07020 * w, y: 0.65506 * h), controlPoint1: CGPoint(x: 0.15077 * w, y: 0.71086 * h), controlPoint2: CGPoint(x: 0.10666 * w, y: 0.69226 * h))
            cloudPath.curve(to: CGPoint(x: 0.01917 * w, y: 0.52041 * h), controlPoint1: CGPoint(x: 0.03375 * w, y: 0.61787 * h), controlPoint2: CGPoint(x: 0.01917 * w, y: 0.57286 * h))
            cloudPath.curve(to: CGPoint(x: 0.04760 * w, y: 0.41179 * h), controlPoint1: CGPoint(x: 0.01917 * w, y: 0.47949 * h), controlPoint2: CGPoint(x: 0.02609 * w, y: 0.44303 * h))
            cloudPath.curve(to: CGPoint(x: 0.13801 * w, y: 0.34148 * h), controlPoint1: CGPoint(x: 0.06911 * w, y: 0.38054 * h), controlPoint2: CGPoint(x: 0.09900 * w, y: 0.35710 * h))
            cloudPath.curve(to: CGPoint(x: 0.18139 * w, y: 0.24997 * h), controlPoint1: CGPoint(x: 0.14165 * w, y: 0.30577 * h), controlPoint2: CGPoint(x: 0.15623 * w, y: 0.27527 * h))
            cloudPath.curve(to: CGPoint(x: 0.27362 * w, y: 0.21240 * h), controlPoint1: CGPoint(x: 0.20654 * w, y: 0.22505 * h), controlPoint2: CGPoint(x: 0.23716 * w, y: 0.21240 * h))
            cloudPath.curve(to: CGPoint(x: 0.34726 * w, y: 0.23547 * h), controlPoint1: CGPoint(x: 0.29731 * w, y: 0.21240 * h), controlPoint2: CGPoint(x: 0.32210 * w, y: 0.22021 * h))
            cloudPath.curve(to: CGPoint(x: 0.44167 * w, y: 0.13057 * h), controlPoint1: CGPoint(x: 0.36986 * w, y: 0.19194 * h), controlPoint2: CGPoint(x: 0.40121 * w, y: 0.15698 * h))
            cloudPath.curve(to: CGPoint(x: 0.57546 * w, y: 0.09114 * h), controlPoint1: CGPoint(x: 0.48177 * w, y: 0.10416 * h), controlPoint2: CGPoint(x: 0.52661 * w, y: 0.09114 * h))
            cloudPath.curve(to: CGPoint(x: 0.75555 * w, y: 0.16628 * h), controlPoint1: CGPoint(x: 0.64582 * w, y: 0.09114 * h), controlPoint2: CGPoint(x: 0.70597 * w, y: 0.11606 * h))
            cloudPath.curve(to: CGPoint(x: 0.82991 * w, y: 0.34892 * h), controlPoint1: CGPoint(x: 0.80512 * w, y: 0.21612 * h), controlPoint2: CGPoint(x: 0.82991 * w, y: 0.27713 * h))
            cloudPath.curve(to: CGPoint(x: 0.82809 * w, y: 0.36045 * h), controlPoint1: CGPoint(x: 0.82991 * w, y: 0.35264 * h), controlPoint2: CGPoint(x: 0.82918 * w, y: 0.35673 * h))
            cloudPath.curve(to: CGPoint(x: 0.93454 * w, y: 0.41737 * h), controlPoint1: CGPoint(x: 0.86819 * w, y: 0.36566 * h), controlPoint2: CGPoint(x: 0.90392 * w, y: 0.38463 * h))
            cloudPath.curve(to: CGPoint(x: 0.98083 * w, y: 0.53380 * h), controlPoint1: CGPoint(x: 0.96516 * w, y: 0.45010 * h), controlPoint2: CGPoint(x: 0.98083 * w, y: 0.48879 * h))
            cloudPath.curve(to: CGPoint(x: 0.93089 * w, y: 0.65878 * h), controlPoint1: CGPoint(x: 0.98083 * w, y: 0.58253 * h), controlPoint2: CGPoint(x: 0.96406 * w, y: 0.62419 * h))
            cloudPath.curve(to: CGPoint(x: 0.80913 * w, y: 0.71086 * h), controlPoint1: CGPoint(x: 0.89772 * w, y: 0.69338 * h), controlPoint2: CGPoint(x: 0.85689 * w, y: 0.71086 * h))
            cloudPath.line(to: CGPoint(x: 0.76976 * w, y: 0.71086 * h))
            path = cloudPath.cgPath
        }
        return path!
    }
    ...
    var circleArrowsPath: CGPath {
        ...
        if path == nil {
            let w2 = frame2.size.width
            let h2 = frame2.size.height
            let circleArrowsPath = NSBezierPath()
            circleArrowsPath.move(to: CGPoint(x: 0.08687 * w2, y: 0.42079 * h2))
            circleArrowsPath.curve(to: CGPoint(x: 0.49224 * w2, y: 0.02726 * h2), controlPoint1: CGPoint(x: 0.12259 * w2, y: 0.19681 * h2), controlPoint2: CGPoint(x: 0.29045 * w2, y: 0.02726 * h2))
            circleArrowsPath.curve(to: CGPoint(x: 0.89760 * w2, y: 0.42079 * h2), controlPoint1: CGPoint(x: 0.69403 * w2, y: 0.02726 * h2), controlPoint2: CGPoint(x: 0.86188 * w2, y: 0.19681 * h2))
            circleArrowsPath.move(to: CGPoint(x: 0.30116 * w2, y: 0.36008 * h2))
            circleArrowsPath.line(to: CGPoint(x: 0.08152 * w2, y: 0.41974 * h2))
            circleArrowsPath.line(to: CGPoint(x: 0.03062 * w2, y: 0.16228 * h2))
            circleArrowsPath.move(to: CGPoint(x: 0.89760 * w2, y: 0.56940 * h2))
            circleArrowsPath.curve(to: CGPoint(x: 0.49224 * w2, y: 0.96292 * h2), controlPoint1: CGPoint(x: 0.86188 * w2, y: 0.79338 * h2), controlPoint2: CGPoint(x: 0.69403 * w2, y: 0.96292 * h2))
            circleArrowsPath.curve(to: CGPoint(x: 0.08687 * w2, y: 0.56940 * h2), controlPoint1: CGPoint(x: 0.29045 * w2, y: 0.96292 * h2), controlPoint2: CGPoint(x: 0.12259 * w2, y: 0.79338 * h2))
            circleArrowsPath.move(to: CGPoint(x: 0.68688 * w2, y: 0.66464 * h2))
            circleArrowsPath.line(to: CGPoint(x: 0.89760 * w2, y: 0.56940 * h2))
            circleArrowsPath.line(to: CGPoint(x: 0.97885 * w2, y: 0.81640 * h2))
            path = circleArrowsPath.cgPath
        }
        return path!
    }
    ...
    var arrowDownPath: CGPath {
        ...
        if path == nil {
            ...
            arrowDownPath.move(to: CGPoint(x: 0.49491 * w, y: 0.90623 * h))
            arrowDownPath.line(to: CGPoint(x: 0.49491 * w, y: 0.09178 * h))
            arrowDownPath.move(to: CGPoint(x: 0.73398 * w, y: 0.64858 * h))
            arrowDownPath.line(to: CGPoint(x: 0.49491 * w, y: 0.92539 * h))
            arrowDownPath.line(to: CGPoint(x: 0.25583 * w, y: 0.64858 * h))
            path = arrowDownPath.cgPath
        }
        return path!
    }
    ...
    var arrowUpPath: CGPath {
        ...
        if path == nil {
            ...
            arrowUpPath.move(to: CGPoint(x: 0.49491 * w, y: 0.11094 * h))
            arrowUpPath.line(to: CGPoint(x: 0.49491 * w, y: 0.92539 * h))
            arrowUpPath.move(to: CGPoint(x: 0.25583 * w, y: 0.36858 * h))
            arrowUpPath.line(to: CGPoint(x: 0.49491 * w, y: 0.09178 * h))
            arrowUpPath.line(to: CGPoint(x: 0.73398 * w, y: 0.36858 * h))
            path = arrowUpPath.cgPath
        }
        return path!
    }
    ...
    var validButtonPath: CGPath {
        ...
        if path == nil {
            let w = frame2.size.width
            let h = frame2.size.height
            let btnPath = NSBezierPath()
            btnPath.move(to: CGPoint(x: 0.20099 * w, y: 0.55099 * h))
            btnPath.line(to: CGPoint(x: 0.50299 * w, y: 0.90099 * h))
            btnPath.line(to: CGPoint(x: 0.85099 * w, y: 0.15079 * h))
            path = btnPath.cgPath
        }
        return path!
    }
    ...
    var waitButtonPath: CGPath {
        ...
        if path == nil {
            ...
            let circleArrowsPath = NSBezierPath()
            circleArrowsPath.move(to: CGPoint(x: 0.08687 * w, y: 0.42079 * h))
            circleArrowsPath.curve(to: CGPoint(x: 0.49224 * w, y: 0.02726 * h), controlPoint1: CGPoint(x: 0.12259 * w, y: 0.19681 * h), controlPoint2: CGPoint(x: 0.29045 * w, y: 0.02726 * h))
            circleArrowsPath.curve(to: CGPoint(x: 0.89760 * w, y: 0.42079 * h), controlPoint1: CGPoint(x: 0.69403 * w, y: 0.02726 * h), controlPoint2: CGPoint(x: 0.86188 * w, y: 0.19681 * h))
            circleArrowsPath.curve(to: CGPoint(x: 0.49224 * w, y: 0.96292 * h), controlPoint1: CGPoint(x: 0.86188 * w, y: 0.79338 * h), controlPoint2: CGPoint(x: 0.69403 * w, y: 0.96292 * h))
            circleArrowsPath.curve(to: CGPoint(x: 0.08687 * w, y: 0.56940 * h), controlPoint1: CGPoint(x: 0.29045 * w, y: 0.96292 * h), controlPoint2: CGPoint(x: 0.12259 * w, y: 0.79338 * h))
            circleArrowsPath.close()
            circleArrowsPath.move(to: CGPoint(x: 0.5 * w, y: 0.5 * h))
            circleArrowsPath.line(to: CGPoint(x: 0.66099 * w, y: 0.33099 * h))
            path = circleArrowsPath.cgPath
    ...
    var waitArrowPath: CGPath {
        ...
        if path == nil {
            ...
            let btnPath = NSBezierPath()
            btnPath.move(to: CGPoint(x: 0.35099 * w, y: 0.5 * h))
            btnPath.line(to: CGPoint(x: 0.5 * w, y: 0.5 * h))
            path = btnPath.cgPath
        }
        return path!
    }
    ...
    var stopButtonPath: CGPath {
        ...
        if path == nil {
            ...
            let btnPath = NSBezierPath()
            btnPath.move(to: CGPoint(x: 0.90299 * w, y: 0.50431 * h))
            btnPath.curve(to: CGPoint(x: 0.49627 * w, y: 0.03448 * h), controlPoint1: CGPoint(x: 0.90299 * w, y: 0.24483 * h), controlPoint2: CGPoint(x: 0.72089 * w, y: 0.03448 * h))
            btnPath.curve(to: CGPoint(x: 0.08955 * w, y: 0.50431 * h), controlPoint1: CGPoint(x: 0.27165 * w, y: 0.03448 * h), controlPoint2: CGPoint(x: 0.08955 * w, y: 0.24483 * h))
            btnPath.curve(to: CGPoint(x: 0.49627 * w, y: 0.97414 * h), controlPoint1: CGPoint(x: 0.08955 * w, y: 0.76379 * h), controlPoint2: CGPoint(x: 0.27165 * w, y: 0.97414 * h))
            btnPath.curve(to: CGPoint(x: 0.90299 * w, y: 0.50431 * h), controlPoint1: CGPoint(x: 0.72089 * w, y: 0.97414 * h), controlPoint2: CGPoint(x: 0.90299 * w, y: 0.76379 * h))
            btnPath.close()
            btnPath.move(to: CGPoint(x: 0.40299 * w, y: 0.37069 * h))
            btnPath.line(to: CGPoint(x: 0.40299 * w, y: 0.66379 * h))
            btnPath.move(to: CGPoint(x: 0.56716 * w, y: 0.37069 * h))
            btnPath.line(to: CGPoint(x: 0.56716 * w, y: 0.66379 * h))
            path = btnPath.cgPath
        }
        return path!
    }
    ...
    var crossButtonPath: CGPath {
        ...
        if path == nil {
            let w = frame2.size.width
            let h = frame2.size.height
            let errPath = NSBezierPath()
            errPath.move(to: CGPoint(x: 0.79468 * w, y: 0.82354 * h))
            errPath.curve(to: CGPoint(x: 0.90299 * w, y: 0.50431 * h), controlPoint1: CGPoint(x: 0.86190 * w, y: 0.73973 * h), controlPoint2: CGPoint(x: 0.90299 * w, y: 0.62757 * h))
            errPath.curve(to: CGPoint(x: 0.49627 * w, y: 0.03448 * h), controlPoint1: CGPoint(x: 0.90299 * w, y: 0.24483 * h), controlPoint2: CGPoint(x: 0.72089 * w, y: 0.03448 * h))
            errPath.curve(to: CGPoint(x: 0.08955 * w, y: 0.50431 * h), controlPoint1: CGPoint(x: 0.27165 * w, y: 0.03448 * h), controlPoint2: CGPoint(x: 0.08955 * w, y: 0.24483 * h))
            errPath.curve(to: CGPoint(x: 0.49627 * w, y: 0.97414 * h), controlPoint1: CGPoint(x: 0.08955 * w, y: 0.76379 * h), controlPoint2: CGPoint(x: 0.27165 * w, y: 0.97414 * h))
            errPath.curve(to: CGPoint(x: 0.79468 * w, y: 0.82354 * h), controlPoint1: CGPoint(x: 0.61419 * w, y: 0.97414 * h), controlPoint2: CGPoint(x: 0.72040 * w, y: 0.91616 * h))
            errPath.close()
            errPath.move(to: CGPoint(x: 0.34018 * w, y: 0.32990 * h))
            errPath.line(to: CGPoint(x: 0.64624 * w, y: 0.68345 * h))
            errPath.move(to: CGPoint(x: 0.35075 * w, y: 0.68345 * h))
            errPath.line(to: CGPoint(x: 0.65681 * w, y: 0.32990 * h))
            path = errPath.cgPath
        }
        return path!
    }
    ...
    var littleArrowUpPath: CGPath {
        let w = _frame!.size.width
        let h = _frame!.size.height
        let arrUpPath = NSBezierPath()
        arrUpPath.move(to: CGPoint(x: 0.45200 * w, y: 0.50074 * h))
        arrUpPath.line(to: CGPoint(x: 0.45200 * w, y: 0.78513 * h))
        arrUpPath.move(to: CGPoint(x: 0.35745 * w, y: 0.59071 * h))
        arrUpPath.line(to: CGPoint(x: 0.45200 * w, y: 0.49405 * h))
        arrUpPath.line(to: CGPoint(x: 0.54655 * w, y: 0.59071 * h))
        layerLittleArrowUp!.frame = _frame!
        return arrUpPath.cgPath
    }
    ...
    var littleArrowDownPath: CGPath {
        let w = _frame!.size.width
        let h = _frame!.size.height
        let arrDownPath = NSBezierPath()
        arrDownPath.move(to: CGPoint(x: 0.61200 * w, y: 0.87026 * h))
        arrDownPath.line(to: CGPoint(x: 0.61200 * w, y: 0.58587 * h))
        arrDownPath.move(to: CGPoint(x: 0.70655 * w, y: 0.78030 * h))
        arrDownPath.line(to: CGPoint(x: 0.61200 * w, y: 0.87695 * h))
        arrDownPath.line(to: CGPoint(x: 0.51745 * w, y: 0.78030 * h))
        layerLittleArrowDown!.frame = _frame!
        return arrDownPath.cgPath
    }
    ...
    var cloudsPath: CGPath {
        let w = _frame!.size.width
        let h = _frame!.size.height
        let cloudsPath = NSBezierPath()
        cloudsPath.move(to: CGPoint(x: 0.44914 * w, y: 0.74233 * h))
        cloudsPath.line(to: CGPoint(x: 0.33726 * w, y: 0.74233 * h))
        cloudsPath.curve(to: CGPoint(x: 0.23247 * w, y: 0.69888 * h), controlPoint1: CGPoint(x: 0.29627 * w, y: 0.74233 * h), controlPoint2: CGPoint(x: 0.26144 * w, y: 0.72785 * h))
        cloudsPath.curve(to: CGPoint(x: 0.18901 * w, y: 0.59408 * h), controlPoint1: CGPoint(x: 0.20350 * w, y: 0.66990 * h), controlPoint2: CGPoint(x: 0.18901 * w, y: 0.63507 * h))
        cloudsPath.curve(to: CGPoint(x: 0.23247 * w, y: 0.48929 * h), controlPoint1: CGPoint(x: 0.18901 * w, y: 0.55309 * h), controlPoint2: CGPoint(x: 0.20350 * w, y: 0.51826 * h))
        cloudsPath.curve(to: CGPoint(x: 0.33726 * w, y: 0.44583 * h), controlPoint1: CGPoint(x: 0.26144 * w, y: 0.46032 * h), controlPoint2: CGPoint(x: 0.29627 * w, y: 0.44583 * h))
        cloudsPath.line(to: CGPoint(x: 0.33726 * w, y: 0.43566 * h))
        cloudsPath.curve(to: CGPoint(x: 0.39428 * w, y: 0.29851 * h), controlPoint1: CGPoint(x: 0.33757 * w, y: 0.38203 * h), controlPoint2: CGPoint(x: 0.35668 * w, y: 0.33642 * h))
        cloudsPath.curve(to: CGPoint(x: 0.53082 * w, y: 0.24149 * h), controlPoint1: CGPoint(x: 0.43219 * w, y: 0.26059 * h), controlPoint2: CGPoint(x: 0.47781 * w, y: 0.24149 * h))
        cloudsPath.curve(to: CGPoint(x: 0.64918 * w, y: 0.28032 * h), controlPoint1: CGPoint(x: 0.57551 * w, y: 0.24149 * h), controlPoint2: CGPoint(x: 0.61496 * w, y: 0.25443 * h))
        cloudsPath.curve(to: CGPoint(x: 0.71883 * w, y: 0.38234 * h), controlPoint1: CGPoint(x: 0.68339 * w, y: 0.30621 * h), controlPoint2: CGPoint(x: 0.70681 * w, y: 0.34042 * h))
        cloudsPath.curve(to: CGPoint(x: 0.78202 * w, y: 0.37155 * h), controlPoint1: CGPoint(x: 0.74041 * w, y: 0.37525 * h), controlPoint2: CGPoint(x: 0.76167 * w, y: 0.37155 * h))
        cloudsPath.curve(to: CGPoint(x: 0.91208 * w, y: 0.42580 * h), controlPoint1: CGPoint(x: 0.83256 * w, y: 0.37155 * h), controlPoint2: CGPoint(x: 0.87602 * w, y: 0.38974 * h))
        cloudsPath.curve(to: CGPoint(x: 0.96633 * w, y: 0.55679 * h), controlPoint1: CGPoint(x: 0.94814 * w, y: 0.46186 * h), controlPoint2: CGPoint(x: 0.96633 * w, y: 0.50562 * h))
        cloudsPath.curve(to: CGPoint(x: 0.91208 * w, y: 0.68778 * h), controlPoint1: CGPoint(x: 0.96633 * w, y: 0.60795 * h), controlPoint2: CGPoint(x: 0.94814 * w, y: 0.65172 * h))
        cloudsPath.curve(to: CGPoint(x: 0.78202 * w, y: 0.74202 * h), controlPoint1: CGPoint(x: 0.87602 * w, y: 0.72384 * h), controlPoint2: CGPoint(x: 0.83256 * w, y: 0.74202 * h))
        cloudsPath.line(to: CGPoint(x: 0.69078 * w, y: 0.74202 * h))
        cloudsPath.move(to: CGPoint(x: 0.45932 * w, y: 0.22762 * h))
        cloudsPath.curve(to: CGPoint(x: 0.44082 * w, y: 0.21128 * h), controlPoint1: CGPoint(x: 0.45346 * w, y: 0.22176 * h), controlPoint2: CGPoint(x: 0.44760 * w, y: 0.21621 * h))
        cloudsPath.curve(to: CGPoint(x: 0.33665 * w, y: 0.17707 * h), controlPoint1: CGPoint(x: 0.41062 * w, y: 0.18847 * h), controlPoint2: CGPoint(x: 0.37579 * w, y: 0.17707 * h))
        cloudsPath.curve(to: CGPoint(x: 0.21644 * w, y: 0.22731 * h), controlPoint1: CGPoint(x: 0.28980 * w, y: 0.17707 * h), controlPoint2: CGPoint(x: 0.24973 * w, y: 0.19371 * h))
        cloudsPath.curve(to: CGPoint(x: 0.16620 * w, y: 0.34905 * h), controlPoint1: CGPoint(x: 0.18316 * w, y: 0.26090 * h), controlPoint2: CGPoint(x: 0.16620 * w, y: 0.30128 * h))
        cloudsPath.curve(to: CGPoint(x: 0.16929 * w, y: 0.35707 * h), controlPoint1: CGPoint(x: 0.16620 * w, y: 0.35306 * h), controlPoint2: CGPoint(x: 0.16744 * w, y: 0.35552 * h))
        cloudsPath.line(to: CGPoint(x: 0.16620 * w, y: 0.35707 * h))
        cloudsPath.curve(to: CGPoint(x: 0.07374 * w, y: 0.39528 * h), controlPoint1: CGPoint(x: 0.13014 * w, y: 0.35707 * h), controlPoint2: CGPoint(x: 0.09932 * w, y: 0.36970 * h))
        cloudsPath.curve(to: CGPoint(x: 0.03552 * w, y: 0.48775 * h), controlPoint1: CGPoint(x: 0.04816 * w, y: 0.42087 * h), controlPoint2: CGPoint(x: 0.03552 * w, y: 0.45169 * h))
        cloudsPath.curve(to: CGPoint(x: 0.07374 * w, y: 0.58021 * h), controlPoint1: CGPoint(x: 0.03552 * w, y: 0.52381 * h), controlPoint2: CGPoint(x: 0.04816 * w, y: 0.55463 * h))
        cloudsPath.curve(to: CGPoint(x: 0.16620 * w, y: 0.61843 * h), controlPoint1: CGPoint(x: 0.09932 * w, y: 0.60579 * h), controlPoint2: CGPoint(x: 0.12984 * w, y: 0.61843 * h))
        cloudsPath.line(to: CGPoint(x: 0.16929 * w, y: 0.61843 * h))
        layerClouds!.frame = _frame!
        return cloudsPath.cgPath
    }
    ...
    var arrowsPath:CGPath {
        let w = _frame!.size.width
        let h = _frame!.size.height
        let arrowsPath = NSBezierPath()
        arrowsPath.move(to: CGPoint(x: 0.62298 * w, y: 0.58977 * h))
        arrowsPath.line(to: CGPoint(x: 0.62298 * w, y: 0.77346 * h))
        arrowsPath.move(to: CGPoint(x: 0.56103 * w, y: 0.64788 * h))
        arrowsPath.line(to: CGPoint(x: 0.62298 * w, y: 0.58545 * h))
        arrowsPath.line(to: CGPoint(x: 0.68493 * w, y: 0.64788 * h))
        arrowsPath.move(to: CGPoint(x: 0.52065 * w, y: 0.86469 * h))
        arrowsPath.line(to: CGPoint(x: 0.52065 * w, y: 0.68100 * h))
        arrowsPath.move(to: CGPoint(x: 0.58260 * w, y: 0.80658 * h))
        arrowsPath.line(to: CGPoint(x: 0.52065 * w, y: 0.86901 * h))
        arrowsPath.line(to: CGPoint(x: 0.45870 * w, y: 0.80658 * h))
        layerArrows!.frame = _frame!
        return arrowsPath.cgPath
    }
    ...
    class func keyPathsForValuesAffectingContentColor() -> Set<AnyHashable>? {
        return Set<AnyHashable>(["_tintColor"])
    }
    
    override public func prepareForInterfaceBuilder() {
        super.prepareForInterfaceBuilder()
        self.setupValues()
        if self.stringType != "None" {
            self.iconType = IconCloudType(stringVal: stringType)
        }
        self.updateLayer()
        self.needsDisplay = true
